...
public final class Constantes {
    ...
    public static final String TEXTO_TITULO_CARRITO = "Your Cart";
    public static final String TEXTO_TITULO_CHECKOUT = "Checkout: Your Information";
    ...
    public static final String ERROR_NOMBRE_REQUERIDO = "Error: First Name is required";
    public static final String ERROR_APELLIDO_REQUERIDO = "Error: Last Name is required";
    public static final String ERROR_CODIGO_POSTAL_REQUERIDO = "Error: Postal Code is required";
}
